...
for k in range(nRow):  #first half
    ...
    while((nSuperCellinRow[k] + 1) * SensorWidth * 8/3 < 2*x_width+10):
        nSuperCellinRow[k] +=1
        ...
        for m in range(0,3):
            for n in range(-1,2):
                if (l%3 == 0):
                    if (m == 2 and n==1):
                        continue
                    PM_positions[nPM][0] = (SensorWidth*n + SensorWidth*l*3 + 3*SensorWidth*cell_dist[j] - triCell*SensorWidth)
                    PM_positions[nPM][1] = -(SensorWidth*m + SensorWidth*j*3)
                ...
                if (l%3 == 1):
                    ...
                    PM_positions[nPM][1] = -(SensorWidth*m + SensorWidth*j*3)
                    if (m ==2):
                        PM_positions[nPM][0] = (SensorWidth*n + SensorWidth*l*3 + 3*SensorWidth*cell_dist[j] - SensorWidth - triCell*SensorWidth)
...
PM_positions[nPM][0] = (SensorWidth*n + SensorWidth*l*3 + 3*SensorWidth*cell_dist[j])
PM_positions[nPM][1] = -(SensorWidth*m + SensorWidth*j*3 + SensorWidth) 
